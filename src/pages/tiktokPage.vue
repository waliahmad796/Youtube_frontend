<template>
  <q-page class="flex flex-center">
    <div class="flex flex-center column full width full-height">
      <div class="row">
        <q-avatar square="" class="col-md-12"
          ><img src="../imgs/6-01.png" alt="tiktok" style="width: 70px"
        /></q-avatar>
        <p class="text-h4 text-weight-bold">Download TikTok videos</p>
      </div>
...
export default {
  ...
  methods: {
    checkUrl() {
      if (this.tiktokUrl.match(this.tiktokRegex)) {
        this.errorMessage = "";
